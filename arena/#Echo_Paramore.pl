    ...
    if ($timer eq "charm_timer") {
        ...
        if ($combat_state == 1) {
            ...
            if ($random_player) {
                ...
                $npc->CastSpell(750, $random_player->GetID(), 10, 0); # Charm spell (750), unresisted, level 10
...
sub EVENT_DEATH_COMPLETE {
    ...
    quest::signalwith(77027,6,2); # Notify NPC with ID 77027 with a 2-second delay when NPC Echo_Paramore dies
