...
sub summon_minions {
    ...
    # Adjust the coordinates slightly to avoid overlapping spawns
    quest::spawn2(63026, 0, 0, $x + 5, $y, $z, $h);
    quest::spawn2(63026, 0, 0, $x - 5, $y, $z, $h);
    quest::spawn2(63026, 0, 0, $x, $y + 5, $z, $h);
    quest::spawn2(63026, 0, 0, $x, $y - 5, $z, $h);
}
...
sub EVENT_DEATH_COMPLETE {
    ...
    quest::signalwith(77027,7,2); # Notify NPC with ID 77027 with a 2-second delay when NPC Echo_Yeule dies
}
