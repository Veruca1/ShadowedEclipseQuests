...
# Invuln unless a Phantasmal Key holder is nearby.
# On death: set mini flag AND award Ember Key if 12 F4 essences are done.
# ===========================================================
...
sub EVENT_DEATH_COMPLETE {
    ...
    # AWARD CHECK HERE (so minis can complete the key)
