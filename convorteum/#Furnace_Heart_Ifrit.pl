# ===========================================================
# 2231.pl – Tower of Shattered Lanterns
# Floor 4 Mini Boss (Furnace Heart Ifrit)
# -----------------------------------------------------------
# Invulnerable until a nearby player has the Phantasmal Key (57162)
# Marks CONV_F4_Mini2231_<CID> on death, allowing default.pl to handle Ember Key logic.
# ===========================================================
...
sub EVENT_DEATH_COMPLETE {
    ...
    my $flag="CONV_F4_Mini2231_${cid}";
    unless(quest::get_data($flag)){
        quest::set_data($flag,1);
        $c->Message(13,"🔥 You have absorbed the burning essence of the Furnace Heart Ifrit!");
    }
