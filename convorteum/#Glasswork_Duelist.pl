# ===========================================================
# 2225.pl – Tower of Shattered Lanterns
# Floor 3 Mini Boss (Glasswork Duelist)
# -----------------------------------------------------------
...
my $CHECK_RADIUS   = 250;
my $CHECK_INTERVAL = 5;
my $LOOT_SEEDED    = 0;       # prevent double roll
...
sub EVENT_DEATH_COMPLETE {
    ...
    my $flag = "CONV_F3_Mini2225_${cid}";

    unless (quest::get_data($flag)) {
        quest::set_data($flag,1);
        $client->Message(13, "✨ You have absorbed the essence of the Glasswork Duelist!");
    }
