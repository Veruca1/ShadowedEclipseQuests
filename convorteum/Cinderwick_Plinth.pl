# ===========================================================
# 2245.pl – Ember_Plinth (Tower Trigger)
# -----------------------------------------------------------
...
# • On death → sends signal 4 to 2242 (Morghast unlock)
# ===========================================================
...
sub _unlock_vul {
    ...
    quest::ze(15, "The Ember Plinth glows red-hot as its protective field collapses!");
}
...
sub EVENT_SPAWN {
    _scale_self_once();
    _lock_invul();
    quest::debug("[2245] Spawned invulnerable, era-scaled Ember Plinth.");
}
...
sub EVENT_DEATH_COMPLETE {
    quest::ze(15, "The Ember Plinth bursts apart in a wave of flame – Morghast’s fiery ward is undone!");
    quest::signalwith(2242, 4);
}