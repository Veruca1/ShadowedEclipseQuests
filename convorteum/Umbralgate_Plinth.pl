# ===========================================================
# 2244.pl – Umbral_Plinth (Tower Trigger)
# -----------------------------------------------------------
...
# • On death → sends signal 5 to 2242 (Morghast unlock)
# ===========================================================
...
sub _unlock_vul {
    ...
    quest::ze(15, "The Umbral Plinth hums with shadowed resonance — its defenses unravel!");
}
...
sub EVENT_SPAWN {
    _scale_self_once();
    _lock_invul();
    quest::debug("[2244] Spawned invulnerable, era-scaled Umbral Plinth.");
}
...
sub EVENT_DEATH_COMPLETE {
    quest::ze(15, "The Umbral Plinth shatters with a pulse of darkness – the final ward around Morghast collapses!");
    quest::signalwith(2242, 5);
}