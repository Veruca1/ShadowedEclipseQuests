# ===========================================================
# 2246.pl – Phantasmal_Plinth (Tower Trigger)
# -----------------------------------------------------------
...
# • On death → sends signal 3 to 2242 (Morghast unlock)
# ===========================================================
...
sub _unlock_vul {
    ...
    quest::ze(15, "The Phantasmal Plinth wails as spectral energy fades – its defenses falter!");
}
...
sub EVENT_SPAWN {
    _scale_self_once();
    _lock_invul();
    quest::debug("[2246] Spawned invulnerable, era-scaled Phantasmal Plinth.");
}
...
sub EVENT_DEATH_COMPLETE {
    quest::ze(15, "The Phantasmal Plinth fractures with a haunting echo – Morghast’s illusory barrier dissipates!");
    quest::signalwith(2242, 3);
}