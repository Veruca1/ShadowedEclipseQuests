...
sub EVENT_DEATH_COMPLETE {
    ...
    # Spawn two additional NPCs at specified locations after death
    quest::spawn2(1626, 0, 0, 350.56, 324.36, -2.35, 459.50);
    quest::spawn2(1627, 0, 0, 372.74, 357.17, -2.35, 372.25);
}
