# 157077.pl - Full Boss Script: Stats, Wrath, Cleanse, Help Call, Respawn Logic
...
sub EVENT_DEATH_COMPLETE {
    # ✅ Depop existing instance of 157088 to prevent duplicate spawns
    my $existing = $entity_list->GetNPCByNPCTypeID(157088);
    $existing->Depop(1) if $existing;

    # ✅ Spawn NPC ID 157088 at specified location
    quest::spawn2(157088, 0, 0, -1535.25, 597.63, -379.94, 124.75);
}