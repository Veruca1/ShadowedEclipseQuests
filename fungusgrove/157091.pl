...
sub EVENT_DEATH_COMPLETE {
    # Depop existing instance of 157078 if it exists to prevent duplicate spawns
    my $existing = $entity_list->GetNPCByNPCTypeID(157078);
    $existing->Depop(1) if $existing;

    # Spawn NPC ID 157078 at specified location
    quest::spawn2(157078, 0, 0, -1097.57, 1020.09, -379.94, 263.75);
}