...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		...
		if (defined $aa_ranks && $aa_ranks >= 1) {
			quest::whisper("Ah, I see you've mastered the art of secondary recall. Here, take this stone.");
			quest::summonitem(40469); # Stone of the Eclipse
		} else {
			quest::whisper("Greetings, traveler. Return to me once you have expanded your arcane abilities.");
		}
	}
}