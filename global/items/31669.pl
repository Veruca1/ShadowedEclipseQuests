sub EVENT_ITEM_CLICK {
    my $item_id = 31669;  # ID of the item being clicked
    ...
    if ($itemid == $item_id) {  # Check if the clicked item ID matches
        ...
        quest::spawn2(1286, 0, 0, $x, $y, $z, $h);  # Spawn at player's location
        quest::say("An Omni Device appears and offers you teleport options.");
    }
}
