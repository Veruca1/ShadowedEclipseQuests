sub EVENT_ITEM_CLICK {
	...
	if ($zoneid != 179) {
		$client->Message(315, "You sense this artifact will only function within the shadows of Akheva Ruins.");
		return;
	}
	...
	$client->Message(315, "The artifact glows with umbral energy before crumbling to dust.");
