sub EVENT_ITEM_CLICK {
	...
	if ($zoneid != 172) {
		$client->Message(315, "You sense this artifact will only function within the mists of Tenebrous Mountains.");
		return;
	}
	...
	$client->Message(315, "The artifact hums with a pale light before crumbling to dust.");
