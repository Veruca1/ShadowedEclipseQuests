sub EVENT_ITEM_CLICK {
	...
	if ($zoneid != 157) {
		$client->Message(315, "This key remains dormant outside the depths of the Fungus Grove.");
		return;
	}
	...
	$client->Message(315, "The key trembles softly... and crumbles in your grasp.");
