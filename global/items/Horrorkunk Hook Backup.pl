#This item summons all mobs in zone to the target and gives them a large hate value. It is known to cause crashes and lag.

# sub EVENT_ITEM_CLICK {
#     my $itemid = 150068;  # Define the item ID to check
