# ===========================================================
# a_manaetic_contraption.pl — Plane of Innovation
...
#   and an alternate “corrupted” illusion model.
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    # ===========================================================
    my $is_boss = 0;  # contraptions are not bosses
    $npc->ModifyNPCStat("level", $is_boss ? 66 : 63);

    # Apply standard baseline stats and raid scaling
    ...
    if (rand() <= 0.20) {
        $glitch_enabled = 1;
        quest::debug("a_manaetic_contraption: Glitch mode activated.");

        # Add guaranteed drop (Shadowed Coven Poppet) when glitching
        $npc->AddItem(56496, 1);
...
# ===========================================================
# Glitch Flicker Logic — toggles between appearances
# ===========================================================
sub EVENT_TIMER {
