...
function event_spawn(e)
    ...
    e.self:ModifyNPCStat("max_hp", "200000000")
    e.self:ModifyNPCStat("hp_regen", "3000")
    e.self:ModifyNPCStat("min_hit", "60000")
    e.self:ModifyNPCStat("max_hit", "110000")
    ...
    eq.zone_emote(MT.Yellow, "The Hobgoblin Anguish Lord emerges from the darkness, his laughter echoing through the nightmare caves!")
end