-- ===========================================================
-- #The_Fearsome_Hobgoblin (Boss)
-- Plane of Nightmare - Spawns 3 unique adds on death
-- ===========================================================
...
-- ===========================================================
-- Death Event - Spawns 3 Unique Adds
-- ===========================================================
function event_death_complete(e)
    -- These are the unique spawns that appear when the Hobgoblin dies
    eq.unique_spawn(204091, 0, 0, 1486, 2652, -80, 380)
    eq.unique_spawn(204092, 0, 0, 1486, 2663, -80, 380)
    eq.unique_spawn(204093, 0, 0, 1486, 2640, -80, 380)

    -- Optional flavor message (commented out)
    -- eq.zone_emote(MT.Yellow, "The Fearsome Hobgoblin collapses, and from the shadows three sinister figures emerge!")
end