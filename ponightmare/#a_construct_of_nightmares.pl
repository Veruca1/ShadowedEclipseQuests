# ===========================================================
# #a_construct_of_nightmares (204064)
# Final boss of Thelin Poxbourne’s Maze — Plane of Nightmare
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    quest::ze(15, "The Construct of Nightmares takes form, its hollow eyes burning with the torment of Thelin’s endless dream!");
}
