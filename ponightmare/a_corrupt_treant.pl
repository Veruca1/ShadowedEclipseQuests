# ===========================================================
# #a_corrupt_treant (204069)
# Support add for Deyid the Twisted - Plane of Nightmare
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    # === Special Abilities ===
    # 3 - immune to mez, 5 - immune to charm, 7 - immune to fear, 8 - immune to stun,
    # 9 - immune to snare, 10 - immune to root, 14 - uncharmable
    ...
    # === Movement ===
    quest::moveto(1011, 1081, 274); # Walks slowly toward Deyid spawn area
}
