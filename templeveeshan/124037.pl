...
# - Uses ToV boss baseline stats (as provided)
# - Integrates RaidScaling
# - Plays zone-wide roar marquee on spawn
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    my $text = "An ear piercing roar comes from the center of the East Wing.";
