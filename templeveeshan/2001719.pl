...
# - Standardized for North Wing poison-themed encounters
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    # === Zone-wide Roar Message ===
    my @clients = $entity_list->GetClientList();
    my $text = "Further northbound, you hear the roar of much larger foes from that of the minions.";
