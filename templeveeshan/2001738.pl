...
# - Triggers cinematic marquee message upon spawn
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    # === Cinematic Marquee Message ===
    $npc->CameraEffect(1000, 3);
    my @clients = $entity_list->GetClientList();
    my $text = "You hear an earpiercing roar from the west end of the west wing.";
