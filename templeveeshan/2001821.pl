...
# - Broadcasts atmospheric zone message on spawn
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    # === Zonewide Marquee Message ===
    my @clients = $entity_list->GetClientList();
    my $text = "Further westward, you hear the roar of much larger creatures beyond the roaming minions.";
