...
-- - Integrates RaidScaling for adaptive raid power (Lua version)
-- - Aggros Lord Kreizenn (124074) and Carx`Vean (124094) when engaged
-- ===========================================================
...
function event_combat(e)
    if e.joined then
        ...
        -- Aggro Lord Kreizenn (124074) and Carx`Vean (124094) if up
