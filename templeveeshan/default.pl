# ===========================================================
# default.pl — Temple of Veeshan (templeveeshan)
# Shadowed Eclipse Scaling System
# - Applies custom baseline stats to all non-excluded NPCs.
# - Integrates RaidScaling for adaptive group and raid power.
# - Designed for high-end Velious dragon encounters and raid tuning.
# ===========================================================
...
sub EVENT_SPAWN {
    ...
    $exclusion_list->{$_} = 1 for (
        124125,   # #A_Glowing_Orb
        2001837,  # As_you_pass
        2001834,  # A_feeling
        2001839,  # A_raging_wind
        2001833,  # A_deafening_roar
        2137,     # an_Icefang_soldier
        1922,     # Nyseria
        1594,     # Nyseria,_the_Veilkeeper
        1595,     # Nyseria`s_Guard
        1207,     # #Thylex_of_Veeshan
        124117,   # Empty_egg_shells
        124120,   # #Feshlak_ChkOne
        124156,   # #Vulak_Trigger
        1327,     # Sir_Bard_McQuaiden
        124142,   # Spawn_Master
        124150,   # Something_seems
        124130,   # The_sound_of
        10        # zone_controller
    );
